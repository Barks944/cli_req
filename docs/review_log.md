...
- SR-0001, SR-0002, SR-0003, SR-0006, SR-0009 (safety requirements, awaiting co-sign)
...
- Next iteration: SR-0009 (achieved-integrity stamp) — verify against the stamp in `sf_show`/`sreq_show` + the `req_0203` test.
